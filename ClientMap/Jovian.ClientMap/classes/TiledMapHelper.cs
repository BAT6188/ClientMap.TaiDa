...
namespace Jovian.ClientMap.classes
{
    ...
    class TiledMapHelper:TiledMapServiceLayer
    {
        ...
        private static string DBName = System.Configuration.ConfigurationManager.AppSettings["DBPath"] + "OfflineTiles.db";//PublicParams.strDBPath + @"OfflineTiles.db";//System.Configuration.ConfigurationManager.AppSettings["DBPath"].Trim();
